...
// This prevents the SDK from loading on page start.
const getAiInstance = async (): Promise<GenAI | null> => {
  ...
  isInitializing = true;
  try {
    // Dynamically import the SDK using the bare module specifier,
    // which will be resolved by the import map in index.html.
